                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="from-control" required maxlength="30" name="company"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="from-control" required maxlength="30" name="department"
                                        placeholder="Eg:IT,HR,..." id="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Designation *</label>
                                    <input type="text" class="from-control" required maxlength="30" name="designation"
                                        placeholder="Eg: CEO,Officer,..." id="">
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="font-sm color-text-muted mb-10">Start Date *</label>
                                    <input type="date" name="start" value="" max="{{ date('Y-m-d') }}"
                                        required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="font-sm color-text-muted mb-10">End Date *</label>
                                    <input type="date" name="end" value="" max="{{ date('Y-m-d') }}"
                                        required>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="responsibilities" maxlength="250" id=""
                                        placeholder="List down some of your responsibilities" class="from-control"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="from-control" required=""
                                        placeholder="Eg: BSc, MSc,Phd,..." name="level" id="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="from-control" required=""
                                        placeholder="Eg: Computer Science,..." name="degree" id="">
                                </div>
                            </div>
                            ...
                            {{-- <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="4" required="" name="year"
                                        placeholder="2024">
                                </div>
                            </div> --}}
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="4" required pattern="\d{4}"
                                        title="Please enter a valid year (four digits)" name="year" id="year"
                                        placeholder="YYYY">
                            ...
                            <script>
                                document.addEventListener('DOMContentLoaded', function() {
                                    ...
                                    yearInput.addEventListener('input', function() {
                                        ...
                                        var isValidYear = /^\d{4}$/.test(inputValue) && parseInt(inputValue) >= 2000 && parseInt(
                                            inputValue) <= currentYear;
                                        if (!isValidYear) {
                                            yearInput.setCustomValidity('Please enter a valid year between 2000 and ' +
                                                currentYear + '.');
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="note" maxlength="250" id="" class="from-control"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="text-right">

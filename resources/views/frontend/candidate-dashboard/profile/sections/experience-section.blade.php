                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('candidate.experience.edit', $experience->id) }}"
                                class="btn btn-default btn-shadow edit-experience" data-bs-toggle="modal"
    ...
    <div>
        <div class="d-flex justify-content-between">
            ...
            <button class="btn btn-default btn-shadow"
                ...
                data-bs-target="#educationModal">Add Eduction</button>
        </div>
        <br>
        <table class="table table-striped">
            <thead>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('candidate.education.edit', $education->id) }}"
                                class="btn btn-default btn-shadow edit-education" data-bs-toggle="modal"

<div class="tab-pane fade show" id="pills-account" role="tabpanel" aria-labelledby="pills-account-tab">
    <form action="{{ route('candidate.profile.account-info.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-group select-style">
                            ...
                            <select name="country" id=""
                                class=" form-icons select-active {{ hasError($errors, 'country') }} country">
                    ...
                    <div class="col-md-4">
                        <div class="form-group select-style">
                            ...
                            <select name="state" id=""
                                class=" form-icons select-active {{ hasError($errors, 'state') }} state">
                                <option value="">Select one</option>
                    ...
                    <div class="col-md-4">
                        <div class="form-group select-style">
                            ...
                            <select name="city" id=""
                                class=" form-icons select-active {{ hasError($errors, 'city') }} city">
                                <option value="">Select one</option>
        ...
        <div class=" mt-15">
            <button class="btn btn-default btn-shadow"> Save All Changes</button>
        </div>
    </form>
    <hr class="">
    <div class="mt-4">
        <form action="{{ route('candidate.profile.account-email.update') }}" method="POST">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-default btn-shadow"> Update Email</button>
            </div>
        </form>
    </div>
    ...
    <div class="mt-4">
        <form action="{{ route('candidate.profile.account-password.update') }}" method="POST">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-default btn-shadow"> Change Password</button>
            </div>
        </form>
    </div>

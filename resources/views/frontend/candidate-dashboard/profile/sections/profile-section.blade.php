                    ...
                    <div class="col-md-6">
                        <div class="form-group select-style">
                            ...
                            <select name="marital_status" id=""
                                ...
                                <option @selected($candidate?->marital_status === 'separated') value="separated">Separated</option>
                                <option @selected($candidate?->marital_status === 'divorced') value="divorced">Divorced</option>
                                <option @selected($candidate?->marital_status === 'widowed') value="widowed">Widowed</option>
                            </select>
                        ...
                        <div class="form-group select-style">
                            ...
                            <select name="language_you_know[]" id=""
                                ...
                                @foreach ($languages as $language)
                                    <option @selected(in_array($language->id, $candidateLanuages)) value="{{ $language->id }}">

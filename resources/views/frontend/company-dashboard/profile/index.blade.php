        ...
        <div class="breacrumb-cover">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <h2 class="mb-20">Employer Profile</h2>
                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                ...
                                aria-selected="true">Employer Info</button>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                            ...
                            <form action="{{ route('company.profile.company-info') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="font-sm color-text-mutted mb-10">Employer Name *</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="font-sm color-text-mutted mb-10">Employer Bio *</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="font-sm color-text-mutted mb-10">Employer Vision *</label>
                        ...
                        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                            <form action="{{ route('company.profile.founding-info') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="font-sm color-text-muted mb-10">Establishment Date</label>
                                            <input type="date" name="establishment_date"
                                                class=" {{ $errors->has('establishment_date') ? 'is-invalid' : '' }}"
                                                value="{{ $companyInfo?->establishment_date }}"
                                                max="{{ date('Y-m-d') }}">
                                            <x-input-error :messages="$errors->get('establishment_date')" class="mt-2" />
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="phone"
                                                ...
                                                value="{{ $companyInfo?->phone }}" pattern="[0-9]{10}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group select-style">
                                            <label class="font-sm color-text-mutted mb-10">Sub-city</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group select-style">
                                            <label class="font-sm color-text-mutted mb-10">street</label>
                                            <select name="city" id=""
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="map_link" class="form-control"
                                                ...
                                                placeholder="http://www.googlemaplocation">
                                        </div>
                                    </div>

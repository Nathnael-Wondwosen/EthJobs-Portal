    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ setSidebarActive(['admin.dashboard']) }}">
                <a href="{{ route('admin.dashboard') }}" class="nav-link"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a></li>
            ...
            <li class="dropdown {{ setSidebarActive(['admin.countries.*', 'admin.states.*', 'admin.cities.*']) }}">
                ...
                <ul class="dropdown-menu">
                    <li class="{{ setSidebarActive(['admin.countries.*']) }}"><a class="nav-link" href="{{ route('admin.countries.index') }}">Cities</a></li>
                    <li class="{{ setSidebarActive(['admin.states.*']) }}"><a class="nav-link" href="{{ route('admin.states.index') }}">Sub-Cities</a></li>
                    <li class="{{ setSidebarActive(['admin.cities.*']) }}"><a class="nav-link" href="{{ route('admin.cities.index') }}">Streets</a></li>
            ...
            <li class="dropdown {{ setSidebarActive([
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setSidebarActive(['admin.reviews.*']) }}"><a class="nav-link" href="{{ route('admin.reviews.index') }}">Developers</a></li>
                </ul>
            </li>
            @endif
            ...
            @endif -->
            @if (canAccess(['AI-Support']))
            <li class="{{ setSidebarActive(['admin.support.*']) }}">  <a class="nav-link" href="{{ route('admin.support.info') }}"><i class="fas fa-robot"></i><span>AI-Support</span></a></li>
            @endif
           ...
           <li class="{{ setSidebarActive(['admin.users.index']) }}"><a class="nav-link" href="{{ route('admin.users.index') }}"><i class="fas fa-users"></i> <span> Users</span></a></li>
            @if (canAccess(['database clear']))
            
        
            <li class="{{ setSidebarActive(['admin.clear-database.index']) }}"><a class="nav-link" href="{{ route('admin.clear-database.index') }}"><i class="fas fa-database"></i> <span>Manage Database</span></a></li>
            @endif

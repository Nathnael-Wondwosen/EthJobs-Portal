...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(config('settings.site_favicon')); ?>">
    ...
    <link href="<?php echo e(asset('frontend/assets/css/all.min.css')); ?>" rel="stylesheet">
...
<body>
    <div class="preloader_demo d-none">
        <div class="img">
            <img src="<?php echo e(asset('frontend/assets/imgs/template/loading.gif')); ?>" alt="joblist">
        </div>
    </div>
    ...
    <div id="preloader-active">
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                <div class="text-center"><img src="<?php echo e(asset('frontend/assets/imgs/template/loading.gif')); ?>"
                        alt="joblist"></div>
            </div>
        </div>
    </div>
    ...
    <script src="<?php echo e(asset('frontend/assets/js/plugins/perfect-scrollbar.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('frontend/assets/js/plugins/Font-Awesome.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('frontend/assets/js/noUISlider.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/assets/js/slider.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('frontend/assets/js/main.js?v=4.1')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\EthJobs-Portal\resources\views/frontend/layouts/master.blade.php ENDPATH**/ ?>
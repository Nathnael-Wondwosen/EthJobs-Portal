      ...
      <div class="row">
        <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
          <div class="login-brand">
            <img src="<?php echo e(config('settings.site_logo')); ?>" alt="logo" width="200" class="shadow-light">
          </div>
...
<?php endif; ?>
              ...
              <form method="POST" action="<?php echo e(route('admin.login')); ?>">
                ...
                <div class="form-group">
                  ...
                  <input id="email" type="email" value="<?php echo e(old('email')); ?>" class="form-control <?php echo e($errors->has('email') ? 'is-invalid' : ''); ?>" name="email" tabindex="1" required autofocus>
...
<?php endif; ?>
          ...
          <div class="simple-footer">
            Copyright &copy;EthJobs <?php echo e(date('Y')); ?>
...
<?php echo $__env->make('admin.auth.layouts.auth-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\EthJobs-Portal\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>
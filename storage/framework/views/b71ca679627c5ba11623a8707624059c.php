...
<section class="section-box mt-75">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 text-center d-none d-lg-block">
          <img src="<?php echo e(asset('frontend/assets/imgs/page/contact/img.png')); ?>" alt="joxBox">
        </div>
  ...
  <section class="contact_map mt-80">
    <div class="container">
      <div class="row">
        <?php if(config('settings.site_map')): ?>
            <?php echo config('settings.site_map'); ?>
  ...
  <script>
    $(document).ready(function() {
        $("#contact-form").on('submit', function(e){
            ...
            $.ajax({
                method: 'POST',
                url: '<?php echo e(route("send-mail")); ?>',
                data: formData,
                beforeSend: function() {
                    button.text("Sending...");
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\EthJobs-Portal\resources\views/frontend/pages/contact.blade.php ENDPATH**/ ?>
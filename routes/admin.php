...
use App\Http\Controllers\Admin\ExportDatabaseController;
...
Route::group(['middleware' => ['auth:admin'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::get('support-info', function () {return view('admin.support-info');})->name('support.info');
    ...
    /*export database */
    Route::get('exports-database', [ClearDatabaseController::class, 'index'])->name('exports-database.index');
    // Route::post('exports-database', [ClearDatabaseController::class, 'exportDatabase'])->name('exports-database');
Route::post('exports-database', [ClearDatabaseController::class,'exportDatabase'])->name('exports-database');

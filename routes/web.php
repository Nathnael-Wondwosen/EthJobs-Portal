...
use App\Http\Controllers\Frontend\FrontendCandidatePageCVController;
...
Route::get('candidates', [FrontendCandidatePageController::class, 'index'])->name('candidates.index')->middleware('verified');
Route::get('candidates/{slug}', [FrontendCandidatePageController::class, 'show'])->name('candidates.show');

/** Generate CV */


Route::get('cv/candidates/{slug}', [FrontendCandidatePageCVController::class, 'showcv'])->name('generatecv.show');
...
Route::group(
    ...
    // Route::post('cv', [CvController::class, 'submit'])->name('cv.submit');
    // Route::post('/Cv', 'CvController@store')->name('resumes.store');
...
// Route::post('/admin/export-database', 'Admin\ClearDatabaseController@exportDatabase')->name('admin.export-database');
Route::get('candidates/{id}/download-cv', [CandidateProfileController::class, 'generateCV'])->name('candidates.cv.index');

//Final try for pdf generator
